...
//we extend RelativeLayout because our button will be composite. And we can put views
//each other very convenient in RelativeLayout
public class SwipeButton extends RelativeLayout {
    //it's moving part of our view
    private ImageView slidingButton;
    //it's the start position of moving part when user starts to move it
    private float initialX;
    //is our button active or no
    private boolean active;
    //it's start width of moving part of our view. We need to save it to return to start posititon
    private int initialButtonWidth;
    //it's the text in the center of our button
    private TextView centerText;

    //icons that moving part use in active/inactive state
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        //here we set background of our swipeButton
        ...
        //here we set text of our SwipeButton
        ...
        centerText.setText("SWIPE"); //add text that you need
        centerText.setTextColor(Color.WHITE);
        centerText.setPadding(35, 35, 35, 35);
        background.addView(centerText, layoutParams);


        //here we add moving part of SwipeButton
        ...
        swipeButton.setBackground(ContextCompat.getDrawable(context, R.drawable.swipe_button_foreground));
